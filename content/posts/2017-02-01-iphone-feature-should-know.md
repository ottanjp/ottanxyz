...
App のバックグラウンド更新は便利です。アプリを起動していなくても、iPhone の限られた権限の範囲内の中でアプリを動作させることができます。たとえば、バックグラウンドでニュースが更新できると、アプリを開いた時から、すぐに最新のニュースを読むことができますよね。しかし、そのバックグラウンド更新は本当に必要なものでしょうか。アプリを開いた時に更新ではダメでしょうか。緊急性が求められる、そもそもバックグラウンド動作が前提のアプリでなければ、「設定」→「一般」→「App のバックグラウンド更新」から個別にアプリをオフにしましょう。バッテリーの節約にもつながりますよ。
